...
<div class="admin-container">
    <div class="admin-header">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-current">Crear Subcategoría</span>
        </div>
        ...
        <form method="POST" class="formulario">
            <fieldset>
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Nota:</strong> Al cambiar el estado de una subcategoría:
                    <ul>
                        <li>Si se <strong>activa</strong>, se activarán todos los productos asociados</li>
                        <li>Si se <strong>desactiva</strong>, se desactivarán todos los productos asociados</li>
            ...
            <div class="acciones">
                ...
                <input type="submit" class="btn btn-primary" value="Crear Subcategoría">
            </div>
        </form>
    </div>
</div>

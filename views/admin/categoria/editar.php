            ...
            <fieldset>
                ...
                <div class="campo">
                    ...
                    <small class="campo-ayuda">
                        ...
                        Modifique el presupuesto asignado para esta categoría
                    </small>
                </div>

                <div class="alert alert-warning">
                    <i class="fas fa-exclamation-triangle"></i>
                    <strong>Importante:</strong> Al cambiar el estado de esta categoría:
                    <ul>
                        <li>Si se <strong>activa</strong>, se activarán automáticamente todas las subcategorías y productos asociados</li>
                        <li>Si se <strong>desactiva</strong>, se desactivarán automáticamente todas las subcategorías y productos asociados</li>
                    </ul>
                </div>
            </fieldset>
